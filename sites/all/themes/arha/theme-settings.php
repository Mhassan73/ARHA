 ...
 *   The form state.
 */
function arha_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['mtt_settings']['tabs'] = array(
    '#type' => 'vertical_tabs',
    '#attached' => array(
      'css' => array(drupal_get_path('theme', 'arha') . '/arha.settings.form.css'),
    ),
  );
  ...
  $form['mtt_settings']['tabs']['basic_settings']['breadcrumb_display'] = array(
    ...
    '#default_value' => theme_get_setting('breadcrumb_display', 'arha'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['tabs']['basic_settings']['fixed_header'] = array(
    ...
    '#default_value' => theme_get_setting('fixed_header', 'arha'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  ); 
  ...
  $form['mtt_settings']['tabs']['basic_settings']['scrolltop_display'] = array(
    ...
    '#default_value' => theme_get_setting('scrolltop_display', 'arha'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['tabs']['basic_settings']['frontpage_content_print'] = array(
    ...
    '#default_value' => theme_get_setting('frontpage_content_print', 'arha'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );  
  ...
  $form['mtt_settings']['tabs']['basic_settings']['bootstrap_js_include'] = array(
    ...
    '#default_value' => theme_get_setting('bootstrap_js_include', 'arha'),
    '#collapsible' => TRUE,
    '#collapsed' => TRUE,
  );
  ...
  $form['mtt_settings']['tabs']['layout']['three_columns_grid_layout'] = array(
    ...
    '#default_value' => theme_get_setting('three_columns_grid_layout', 'arha'),
    '#options' => array(
  ...
  $form['mtt_settings']['tabs']['looknfeel']['color_scheme'] = array(
    ...
    '#default_value' => theme_get_setting('color_scheme', 'arha'),
    '#options' => array(
    'default' => t('Gray'),
  ...
  $form['mtt_settings']['tabs']['looknfeel']['form_style'] = array(
    ...
    '#default_value' => theme_get_setting('form_style', 'arha'),
    '#options' => array(
  ...
  $form['mtt_settings']['tabs']['font']['sitename_font_family'] = array(
    '#type' => 'select',
    '#title' => t('Site name'),
    '#default_value' => theme_get_setting('sitename_font_family', 'arha'),
    '#options' => array(
  ...
  $form['mtt_settings']['tabs']['font']['slogan_font_family'] = array(
    '#type' => 'select',
    '#title' => t('Slogan'),
    '#default_value' => theme_get_setting('slogan_font_family', 'arha'),
    '#options' => array(
  ...
  $form['mtt_settings']['tabs']['font']['headings_font_family'] = array(
    '#type' => 'select',
    '#title' => t('Headings'),
    '#default_value' => theme_get_setting('headings_font_family', 'arha'),
    '#options' => array(
  ...
  $form['mtt_settings']['tabs']['font']['paragraph_font_family'] = array(
    '#type' => 'select',
    '#title' => t('Paragraph'),
    '#default_value' => theme_get_setting('paragraph_font_family', 'arha'),
    '#options' => array(
  ...
  $form['mtt_settings']['tabs']['slideshow']['main_slideshow']['slideshow_effect'] = array(
    ...
    '#default_value' => theme_get_setting('slideshow_effect', 'arha'),
    '#options' => array(
    'fade' => t('fade'),
    'slide' => t('slide'),
    ),
  ...
  $form['mtt_settings']['tabs']['slideshow']['main_slideshow']['slideshow_effect_time'] = array(
    ...
    '#default_value' => theme_get_setting('slideshow_effect_time', 'arha'),
  ...
  $form['mtt_settings']['tabs']['responsive_menu']['responsive_multiLevel_menu']['responsive_multilevelmenu_state'] = array(
    ...
    '#default_value' => theme_get_setting('responsive_multilevelmenu_state', 'arha'),
  );
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_contact']['google_map_js'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_js','arha'),
  );
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_contact']['google_map_latitude'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_latitude','arha'),
    '#size' => 5,
    '#maxlength' => 10,
  );  
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_contact']['google_map_longitude'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_longitude','arha'),
    '#size' => 5,
    '#maxlength' => 10,
  ); 
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_contact']['google_map_zoom'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_zoom','arha'),
    '#size' => 5,
    '#maxlength' => 10,
  ); 
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_contact']['google_map_canvas'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_canvas','arha'),
  ); 
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_event']['google_map_event_js'] = array(
    ...
    '#default_value' => theme_get_setting('google_map_event_js','arha'),
  );
  ...
  $form['mtt_settings']['tabs']['google_map']['google_map_event']['google_map_event_zoom'] = array(
    ...
    '#title' => t('Google Maps Zoom'),
    '#description'   => t('For example 13'),
    '#default_value' => theme_get_setting('google_map_event_zoom','arha'),
    '#size' => 5,
    '#maxlength' => 10,
  ); 
